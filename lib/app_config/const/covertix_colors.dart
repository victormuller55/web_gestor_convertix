...
class ConvertixColors {
  ...
  static const Color sidebarBackground = primaryDarker;
  ...
  static const Color menuPanel = Color(0xFFF3F4F6);
  ...
  static const LinearGradient loginPanelGradient = LinearGradient(
    ...
    colors: [Color(0xFF000510), primaryDarker, primaryDark, primary],
    stops: [0, 0.35, 0.65, 1],
  );
  ...
  static const LinearGradient brandPanelGradient = LinearGradient(
    ...
    colors: [Color(0xFFFFFFFF), Color(0xFFF0F4FF), Color(0xFFE6EAFF)],
    stops: [0, 0.55, 1],
  );
